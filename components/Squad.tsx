      ...
      <div className="contain">
        ...
        <div className="ribbon-wrap" style={{ marginTop: 'clamp(24px,3vw,40px)' }}>
          <div className="ribbon-track" style={{ display: 'flex', gap: '12px', overflowX: 'auto', padding: '4px 2px 24px' }}>
            {players.map((p: any) => (
              <div key={p._id} className="card" style={{ flex: '0 0 clamp(180px,22vw,220px)', aspectRatio: '3/4' }}>
                <div className="card-inner">
                  <div className="card-front">
                    ...
                    <div>
                      ...
                      <div className="card-name-init">{p.firstName?.[0]}. {p.lastName}</div>
                    </div>
                  </div>
                  <div className="card-back">
                    <div className="card-back-head">
                      <div className="card-back-name">{p.firstName} {p.lastName}</div>
